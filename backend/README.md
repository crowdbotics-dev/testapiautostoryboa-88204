...
## Project Structure
    ...
    ├── testapiautostoryboa_88204  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_88204`
...
2. Clone this repo and `cd testapiautostoryboa_88204`
